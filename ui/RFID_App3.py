...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        font = QtGui.QFont()
        font.setPointSize(20)  # Adjust font size as needed
        font.setBold(True)
        ...
        self.register_layout.addWidget(self.register_button, 5, 1)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1200, 21))  # Adjusted width
